...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <a href="findus.php" class="btn">Find nearest store</a>
        </div>
    ...
    <section class="products" id="products">
        ...
        <div class="products-container">
            <div class="box">
                ...
                <div class="content">
                    <span>8 DT</span>
                    <a class="add-to-cart" href="./Frappucino.php">Add to cart</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    <span>7.5 DT</span>
                    <a class="add-to-cart" href="./Caramel-Coffee.php">Add to cart</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    <span>6 DT</span>
                    <a class="add-to-cart" href="./Iced-Coffee.php">Add to cart</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    <span>12 DT</span>
                    <a class="add-to-cart" href="./Strawberry-juice.php">Add to cart</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    <span>19.99 DT</span>
                    <a class="add-to-cart" href="./German-cake.php">Add to cart</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    <span>4.99 DT</span>
                    <a class="add-to-cart" href="./Chocolate-Donuts.php">Add to cart</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    <span>3.99 DT</span>
                    <a class="add-to-cart" href="./Chocolate-cake.php">Add to cart</a>
                </div>
            </div>
            <div class="box">
                ...
                <div class="content">
                    <span>9.5 DT</span>
                    <a class="add-to-cart" href="./Our-cookies.php">Add to cart</a>
                </div>
            </div>
            <div class="rateus">
    ...
    <section class="customers" id="customers">
        ...
        <div class="customers-container">
            ...
            <div class="box">
                ...
                <p>A Place to Be. The space I chose was "KYUFI - كيوفي". Never in my life would I have imagined that I would be interested in writing a paper about this. I am currently traveling and it has been a place that I have been frequently visiting to sit down and take care of my studies.</p>
                <h2>Riadh Ibrahim</h2>
    ...
    <section class="footer">
        <div class="footer-box">
            ...
            <div class="social">
                <a href="https://www.facebook.com/profile.php?id=100092295501485"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/kyuficoffeeshop/"><i class="fa-brands fa-instagram"></i></a>
                <a href="#"><i class="fa-brands fa-twitter"></i></a>
                <a href="https://www.tiktok.com/@kyufi_coffee_shop"><i class="fa-brands fa-tiktok"></i></a>
            </div>
        </div>
        <div class="footer-box">
            <h3>Support :</h3>
            <li><a href="./Products-Page-2.php">Products</a></li>
        ...
        <div class="footer-box">
            ...
            <li><a id="" href="./joinus.php">Careers</a></li>
            <li><a href="">Blog Posts</a></li>
            <li><a href="./findus.php">Our Branches</a></li>
        </div>
        <div class="footer-box">
            <h3>Contact Us :</h3>
            <div class="contact">
                <span><i class="fas fa-map-marker-alt"></i> Laouina Tunis, Ariana 2080</span>
                <span><i class="fas fa-phone"></i>+216 22 222 222</span>
                <span><i class="fas fa-envelope"></i> kyuficoffeeshop@gmail.com</span>
            </div>
        </div>
    </section>
    <div class="copyright">
