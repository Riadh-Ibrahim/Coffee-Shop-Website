...
<body>
    ...
    <section class="home">
        <div class="home-text">
            ...
            <br>
            <a href="./Products-Page-2.html" class="btn" id="fbtn">Shop now</a>
    ...
    <section class="products" id="products">
        ...
        <div class="products-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    <span>7.5 DT</span>
                    <a class="add-to-cart" href="./shopping cart.html">Add to cart</a>
                </div>
            </div>
            ...
            <div class="rateus">
                <button style="width: 80%; font-weight: 450; margin-left: 160%;"><a href="./Products-Page-2.html">View More Products</a></button>
            </div>
        </div>
    </section>
    <section class="customers" id="customers">
        ...
        <div class="rateus">
            <button><a href="rate.html">Rate Us</a></button>
        </div>
    </section>
    ...
    <section class="footer">
        ...
        <div class="footer-box">
            ...
            <li><a href="rate.html">Help & Support</a></li>
