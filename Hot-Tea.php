    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Tea</span>
            <h1>Hot-Tee</h1>
            <p>Hot teas are warm beverages made by steeping tea leaves or herbs in hot water, offering a variety of flavors and potential health benefits. They are cherished for their comforting warmth and rich aroma.</p>
          </div>
          ...
          <div class="product-configuration">
            ...
            <div class="Coffee-config">
              ...
              <div class="Coffee-choose">
                ...
                <button style="width:50%" >Chai Tea</button>
                <button style="width:50%" >Chai Tea Latte</button></div>
                <div class="btn-group" style="width:100%">

                <button style="width:50%" >Mint Majesty</button>
                <button style="width:50%" >Matcha Tea Latte</button></div>
              </div>
  
            </div>
          </div>
          <div class="Size-configuration">
          ...
          <div class="product-price">
            <span>1.99 DT</span>
            <h6 class="text-muted ml-2"><del>DT 2.99</del></h6>
            <span></span>
