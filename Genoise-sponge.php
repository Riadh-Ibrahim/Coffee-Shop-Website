...
<head>
    ...
    <title>Genoise Sponge Cake</title>
...
<header>
    ...
    <main class="container2">
        ...
        <div class="left-column">
          <img  src="images/Genoise-sponge.jpg" alt="">
        </div>
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Cake</span>
            <h1>Genoise Sponge Cake
            </h1>
            <p>Genoise sponge (also called Genoese or Genovese cake) is a classic European sponge cake that's incredibly fluffy and light-as-air! Slice into layers and add any filling of your choice to create a delicious layer cake!</p>
          </div>
          ...
          <div class="product-price">
            ...
            <a href="add_to_cart_function.php?prodselected=17" class="cart-btn">Add to cart</a>
          </div>
        </div>
