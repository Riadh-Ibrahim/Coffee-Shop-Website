        ...
        <div class="right-column">
          ...
          <div class="product-configuration">
            <div class="Coffee-config">
                <span>Choose Your Cupcakes :</span>
    
                <div class="Coffee-choose">
                  <div class="btn-group" style="width:100%">
                  <button style="width:50%" >Frosting + Fruit</button>
                  <button style="width:50%" >Frosting + Candy</button></div>
                  <div class="btn-group" style="width:100%">
  
                  <button style="width:50%" >Frosting only</button>
                  <button style="width:50%" >Chocolate</button></div>
          ...
          <div class="product-price">
            ...
            <a href="add_to_cart_function.php?prodselected=15" class="cart-btn">Add to cart</a>
          </div>
        </div>
