    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Coffee</span>
            <h1>Frappuccino</h1>
            <p>Frappuccino is a line of blended iced coffee drinks sold by Koofi. It may consists of coffee or crème base, blended with ice and ingredients such as flavored syrups and usually topped with whipped cream and or spices.It may also include blended Koofi refreshers.</p>
          </div>
          ...
          <div class="product-configuration">
            ...
            <div class="Coffee-config">
              ...
              <div class="Coffee-choose">
                <button>Chai</button>
                <button>Vanilla Bean Crème</button>
                <button>Strawberries And Crème</button>
              </div>
            ...
            <div class="Coffee-config">
              ...
              <div class="Coffee-choose">
                <div class="btn-group" style="width:100%">
                  ...
                  <button style="width:50%" >Large Cup</button>
                  <button style="width:50%" >Medium Cup</button></div>
          ...
          <div class="product-price">
            <span>1.99DT</span>
            <h6 class="text-muted ml-2"><del>DT2.50</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=2" class="cart-btn">Add to cart</a>
          </div>
        </div>
