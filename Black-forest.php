    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Cake</span>
            <h1>Black Forest Cake
            </h1>
            <p>Black Forest gâteau or Black Forest cake is a chocolate sponge cake with a rich cherry filling based on the German dessert Schwarzwälder Kirschtorte, literally "Black Forest Cherry-torte". Typically, Black Forest gateau consists of several layers of chocolate sponge cake sandwiched with whipped cream and cherries.</p>
          </div>
            ...
            <div class="Coffee-config">
              ...
              <div class="Coffee-choose">
                <div class="btn-group" style="width:100%">
                  ...
                  <button style="width:50%" >Large Sized Cake</button>
                  <button style="width:50%" >Medium Sized Cake</button></div>
          ...
          <div class="product-price">
            <span>7.99DT</span>
            <h6 class="text-muted ml-2"><del>DT9.99</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=16" class="cart-btn">Add to cart</a>
          </div>
        </div>
