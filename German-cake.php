    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Cake</span>
            <h1>German Cake</h1>
            <p>German chocolate cake, originally German's chocolate cake, is a layered chocolate cake filled and topped with a coconut-pecan frosting.</p>
          </div>
          ...
          <div class="product-price">
            ...
            <a href="add_to_cart_function.php?prodselected=10" class="cart-btn">Add to cart</a>
          </div>
        </div>
