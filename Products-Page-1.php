                        ...
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$3.99</h5><h6 class="text-muted ml-2"><del>$4.99</del></h6>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$3.49</h5><h6 class="text-muted ml-2"><del>$5.49</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-warning mr-1"></small>
                                    <small class="fa fa-star text-warning mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$4.20</h5><h6 class="text-muted ml-2"><del>$6.99</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-warning mr-1"></small>
                                    <small class="fa fa-star text-warning mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$2.49</h5><h6 class="text-muted ml-2"><del>$4.99</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-warning mr-1"></small>
                                    <small class="fa fa-star text-warning mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$7.99</h5><h6 class="text-muted ml-2"><del>$9.99</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-warning mr-1"></small>
                                    <small class="fa fa-star text-warning mr-1"></small>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$2.99</h5><h6 class="text-muted ml-2"><del>$3.50</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-warning mr-1"></small>
                                    <small class="fa fa-star text-warning mr-1"></small>
