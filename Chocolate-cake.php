    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            ...
            <p>Chocolate cake or chocolate gâteau is a cake flavored with melted chocolate, cocoa powder, or both.</p>
          </div>
          ...
          <div class="product-price">
            <span>3.49DT</span>
            <h6 class="text-muted ml-2"><del>DT5.49</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=12" class="cart-btn">Add to cart</a>
          </div>
        </div>
