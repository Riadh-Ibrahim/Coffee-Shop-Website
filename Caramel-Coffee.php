    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            ...
            <p>What is caramel coffee made of? Caramel coffee is a drink made from brewed coffee, caramel sauce, milk, and whipped cream. The coffee is typically brewed with a French press or pour over brewer like the Chemex.</p>
          </div>
          ...
          <div class="product-price">
            <span>2.99DT</span>
            <h6 class="text-muted ml-2"><del>DT4.99</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=4" class="cart-btn">Add to cart</a>
          </div>
        </div>
