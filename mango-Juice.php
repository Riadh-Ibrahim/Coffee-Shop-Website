    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Juice</span>
            <h1>Mango juice</h1>
            <p>Mango juice is a beverage made from the extracted juice of mango fruit, typically with added sweeteners or other fruit juices, and it has a sweet, tangy, and refreshing taste.</p>
          </div>
          ...
          <div class="product-price">
            <span>2.99 DT</span>
            <h6 class="text-muted ml-2"><del>DT 4.99</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=8" class="cart-btn">Add to cart</a>
          </div>
        </div>
