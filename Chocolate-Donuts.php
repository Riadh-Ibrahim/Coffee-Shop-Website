    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            ...
            <p>Moist and fluffy baked chocolate donuts full of chocolate flavor. Covered in a thick, chocolate glaze, these are perfect for any chocoholic.
            </p>
          </div>
          ...
          <div class="product-configuration">
            <div class="Coffee-config">
              <span>Choose Your Preferred Forsting :</span>
  
              <div class="Coffee-choose">
                <div class="btn-group" style="width:100%">

                  <button style="width:50%" >Candy</button>
                  <button style="width:50%" >Sugar</button></div>
          ...
          <div class="product-price">
            ...
            <a href="add_to_cart_function.php?prodselected=11" class="cart-btn">Add to cart</a>
          </div>
        </div>
