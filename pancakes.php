        ...
        <div class="right-column">
          ...
          <div class="product-configuration">
            <div class="Coffee-config">
              <span>Choose Your Preferred type :</span>
  
              <div class="Coffee-choose">
                <div class="btn-group" style="width:100%">

                  <button style="width:50%" >American-Style Pancakes</button>
                  <button style="width:50%" >French Crêpes</button></div>
          ...
          <div class="product-price">
            <span>2.99 DT</span>
            <h6 class="text-muted ml-2"><del>DT 3.50</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=18" class="cart-btn">Add to cart</a>
          </div>
        </div>
