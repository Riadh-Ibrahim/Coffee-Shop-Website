    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Cookies</span>
            <h1>Our Cookies</h1>
            <p>A cookie, or a biscuit, is a baked or cooked snack or dessert that is typically small, flat and sweet. It usually contains flour, sugar, egg, and some type of oil, fat, or butter. It may include other ingredients such as raisins, oats, chocolate chips, nuts, etc..</p>
          </div>
          ...
          <div class="product-configuration">
            ...
            <div class="Coffee-config">
              <span>Choose Your favourite type :</span>
  
              <div class="Coffee-choose">
                <div class="btn-group" style="width:100%">
                <button style="width:50%" >Raisin Cookies</button>
                <button style="width:50%" >Chocolate Cookies</button></div>
                <div class="btn-group" style="width:100%">

                <button style="width:50%" >Nuts Cookies</button>
                <button style="width:50%" >Special Cookies</button></div>
          ...
          <div class="product-price">
            <span>2.49 DT</span>
            <h6 class="text-muted ml-2"><del>DT 5.99</del></h6>
            <span></span>
              
            <a href="add_to_cart_function.php?prodselected=13" class="cart-btn">Add to cart</a>
          </div>
        </div>
