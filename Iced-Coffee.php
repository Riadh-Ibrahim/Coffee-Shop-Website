    ...
    <main class="container2">
        ...
        <div class="right-column">
          ...
          <div class="product-description">
            <span>Coffee</span>
            <h1>Iced Coffee</h1>
            <p>Iced coffee is a coffee beverage served cold. It is prepared  by brewing coffee normally and then serving it over ice or in cold milk.</p>
          </div>
            ...
            <div class="Coffee-config">
              ...
              <div class="Coffee-choose">
                ...
                <div class="btn-group" style="width:100%">
                  <button style="width:50%" >Iced Espresso</button>
                  <button style="width:50%" >Cold Brew</button></div>
                  <div class="btn-group" style="width:100%">
  
                  <button style="width:50%" >Mazagran</button>
                  <button style="width:50%" >Normal Iced Coffee</button></div>
              </div>
          ...
          <div class="product-price">
            <span>2.99$</span>
            <h6 class="text-muted ml-2"><del>$4.99</del></h6>
            <span></span>
